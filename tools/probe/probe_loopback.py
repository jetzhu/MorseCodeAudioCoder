...
FS, F0, WPM, IN_DEV, OUT_DEV = 48000, 1000.0, 15, int(sys.argv[1]) if len(sys.argv) > 1 else 18, 3
...
x = np.concatenate(chunks); wavfile.write("loopback.wav", FS, (np.clip(x, -1, 1) * 32767).astype(np.int16))
