...
- Show panels (2026-09-26, v0.1.18; replaces the v0.1.17 handset-only
  ...
  classes `hide-audio`, `hide-light`, `audio-s|l`, `light-s|l`; localStorage
  `morse.show`). Hidden panels keep working; a hidden camera preview is
  sampled on animation frames because it gets no video-frame callbacks.
